...
<body>
	...
	<div align="center">
		...
		<table>
			...
			<tr>
				<td><b>Phone:</b></td>
				<td><input type="text" name="recipientPhone" id="phone" value="${order.phone}" size="45" /></td>
			</tr>
			<tr>
		...
		<table border="1">
			...
			<c:forEach items="${order.orderDetails}" var="orderDetail" varStatus="status" >
				<tr>
					...
					<td><a href="remove_book_order?id=${orderDetail.book.bookId}">Remove</a></td>
				</tr>
			</c:forEach>
			<tr>
				<td colspan="7" align="right">
					...
					<p>Shipping Fee: <input type="text" size="5" name="shippingFee" id="shippingFee"  value="${order.shippingFee}" type="currency" /></p>
