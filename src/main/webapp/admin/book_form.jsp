		        ...
		        <form action="create_book" method="post" id="bookForm"  enctype="multipart/form-data" >
						...
						<table class="form">
								<tr>
									...
									<td>
										<select name="category">
											<c:forEach items="${listCategoryname}" var="category">
								...
								<tr>
									...
									<td align="left"><input type="text" name="title"  size="20"  id="title" value="${book.title}" /></td>
								</tr>
								<tr>
									<td align="right">Author:</td>
									<td align="left"><input type="text" name="author"  size="20"  id="author"  value="${book.author}" /></td>
								</tr>
								<tr>
									<td align="right">ISBN:</td>
									<td align="left"><input type="text" name="isbn" size="20"  id="isbn"  value="${book.isbn}" /></td>
								</tr>
								<tr>
									<td align="right">Publish Date:</td>
									<td align="left"><input type="text" name="publishDate" size="20"  id="publishDate"  
								...
								<tr>
									...
									<td align="left"><input type="text" name="price" size="20"  id="price"  value="${book.price}" /></td>
								</tr>
								<tr>
