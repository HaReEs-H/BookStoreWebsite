...
public class ReviewServices {
	...
	public void submitReview() throws ServletException, IOException {
		...
		Customer cutomer=(Customer) request.getSession().getAttribute("loggedCustomer");
		
		newReview.setCustomer(cutomer);
		reviewDAO.create(newReview);
		
		String msgPage="frontend/review_done.jsp";
		RequestDispatcher dispatcher=request.getRequestDispatcher(msgPage);
		dispatcher.forward(request, response);
	}
