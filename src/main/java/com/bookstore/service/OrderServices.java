...
//	}
	...
	public void showOrderDetailForCustomer() throws ServletException, IOException {
		...
		String detialPage="frontend/order_detail.jsp";
		RequestDispatcher dispatcher=request.getRequestDispatcher(detialPage);
		dispatcher.forward(request, response);
	}
	...
	public void updateOrder() throws ServletException, IOException {
		...
		String message="This order"+order.getOrderId()+"has been updated successfully";
	...
	public void deleteOrder() throws ServletException, IOException {
		...
		String message="This order ID "+orderId+" has been deleted.";
		listAllOrder(message);
	}
