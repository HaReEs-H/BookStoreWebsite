...
public class Book implements java.io.Serializable {
	...
	public Book(String title, String author, byte[] image, float price, Date publishDate, Date lastUpdateTime,
			String categoryId) {
		this.title = title;
		this.author = author;
		this.image = image;
	...
	public Book(String title, String author, byte[] image, float price, Date publishDate, Date lastUpdateTime,
			String categoryId, Set<Review> reviews, Set<OrderDetail> orderDetails) {
		this.title = title;
		this.author = author;
		this.image = image;
		this.price = price;
